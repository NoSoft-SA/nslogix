...
#   ruby tcp_serv.rb
# Que CLI job server:
#   bundle exec que -q nslogix ./app_loader.rb
#   OR (in cron)
#   cd /home/nsld/logix/current && screen -dmS nslogixque bash -c 'source /usr/local/share/chruby/chruby.sh && chruby ruby-2.5.0 && RACK_ENV=production bundle exec que -q nslogix ./app_loader.rb'
