...
module MasterfilesApp
  class FarmRepo < BaseRepo # rubocop:disable Metrics/ClassLength
    build_for_select :production_regions, label: :production_region_code, value: :id, order_by: :production_region_code
    build_inactive_select :production_regions, label: :production_region_code, value: :id, order_by: :production_region_code
    crud_calls_for :production_regions, name: :production_region, wrapper: ProductionRegion

    build_for_select :farm_groups, label: :farm_group_code, value: :id, order_by: :farm_group_code
    build_inactive_select :farm_groups, label: :farm_group_code, value: :id, order_by: :farm_group_code
    crud_calls_for :farm_groups, name: :farm_group, wrapper: FarmGroup

    build_for_select :farms, label: :farm_code, value: :id, order_by: :farm_code
    build_inactive_select :farms, label: :farm_code, value: :id, order_by: :farm_code
    crud_calls_for :farms, name: :farm, wrapper: Farm

    build_for_select :orchards, label: :orchard_code, value: :id, order_by: :orchard_code
    build_inactive_select :orchards, label: :orchard_code, value: :id, order_by: :orchard_code
    crud_calls_for :orchards, name: :orchard, wrapper: Orchard

    build_for_select :farm_sections, label: :farm_section_name, value: :id, no_active_check: true, order_by: :farm_section_name
    build_inactive_select :farm_sections, label: :farm_section_name, value: :id, order_by: :farm_section_name
    crud_calls_for :farm_sections, name: :farm_section, wrapper: FarmSection

    build_for_select :pucs,  label: :puc_code, value: :id, order_by: :puc_code
    build_inactive_select :pucs, label: :puc_code, value: :id, order_by: :puc_code
    ...
    def associate_farms_pucs(id, farms_pucs_ids)
      ...
      new_farms_pucs_ids.each do |puc_id|
        DB[:farms_pucs].insert(farm_id: id, puc_id: puc_id)
      end
    end
