...
Sequel.migration do
  up do
    ...
    pgt_created_at(:master_lists,
                   :created_at,
                   function_name: :pgt_master_lists_set_created_at,
                   trigger_name: :set_created_at)
    pgt_updated_at(:master_lists,
                   :updated_at,
                   function_name: :pgt_master_lists_set_updated_at,
                   trigger_name: :set_updated_at)
  end

  down do
    drop_trigger(:master_lists, :set_created_at)
    drop_function(:pgt_master_lists_set_created_at)
    drop_trigger(:master_lists, :set_updated_at)
    drop_function(:pgt_master_lists_set_updated_at)
