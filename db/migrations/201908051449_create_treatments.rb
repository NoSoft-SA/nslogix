...
Sequel.migration do
  up do
    ...
    pgt_created_at(:treatment_types,
                   :created_at,
                   function_name: :pgt_treatment_types_set_created_at,
                   trigger_name: :set_created_at)
    pgt_updated_at(:treatment_types,
                   :updated_at,
                   function_name: :pgt_treatment_types_set_updated_at,
    ...
    pgt_created_at(:treatments,
                   :created_at,
                   function_name: :pgt_treatments_set_created_at,
                   trigger_name: :set_created_at)
    pgt_updated_at(:treatments,
                   :updated_at,
                   function_name: :pgt_treatments_set_updated_at,
                   trigger_name: :set_updated_at)
  ...
  down do
    ...
    drop_function(:pgt_treatments_set_created_at)
    drop_trigger(:treatments, :set_updated_at)
    drop_function(:pgt_treatments_set_updated_at)
    ...
    drop_function(:pgt_treatment_types_set_created_at)
    drop_trigger(:treatment_types, :set_updated_at)
    drop_function(:pgt_treatment_types_set_updated_at)
