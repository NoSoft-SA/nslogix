...
Sequel.migration do
  up do
    ...
    pgt_created_at(:target_market_group_types,
                   :created_at,
                   function_name: :pgt_target_market_group_types_set_created_at,
                   trigger_name: :set_created_at)
    pgt_updated_at(:target_market_group_types,
                   :updated_at,
                   function_name: :pgt_target_market_group_types_set_updated_at,
    ...
    pgt_created_at(:target_market_groups,
                   :created_at,
                   function_name: :pgt_target_market_groups_set_created_at,
                   trigger_name: :set_created_at)
    pgt_updated_at(:target_market_groups,
                   :updated_at,
                   function_name: :pgt_target_market_groups_set_updated_at,
                   trigger_name: :set_updated_at)
    ...
    pgt_created_at(:target_markets,
                   :created_at,
                   function_name: :pgt_target_markets_set_created_at,
                   trigger_name: :set_created_at)
    pgt_updated_at(:target_markets,
                   :updated_at,
                   function_name: :pgt_target_markets_set_updated_at,
                   trigger_name: :set_updated_at)
    ...
    pgt_created_at(:destination_regions,
                   :created_at,
                   function_name: :pgt_destination_regions_set_created_at,
                   trigger_name: :set_created_at)
    pgt_updated_at(:destination_regions,
                   :updated_at,
                   function_name: :pgt_destination_regions_set_updated_at,
                   trigger_name: :set_updated_at)
    ...
    pgt_created_at(:destination_countries,
                   :created_at,
                   function_name: :pgt_destination_countries_set_created_at,
                   trigger_name: :set_created_at)
    pgt_updated_at(:destination_countries,
                   :updated_at,
                   function_name: :pgt_destination_countries_set_updated_at,
                   trigger_name: :set_updated_at)
    ...
    pgt_created_at(:destination_cities,
                   :created_at,
                   function_name: :pgt_destination_cities_set_created_at,
                   trigger_name: :set_created_at)
    pgt_updated_at(:destination_cities,
                   :updated_at,
                   function_name: :pgt_destination_cities_set_updated_at,
                   trigger_name: :set_updated_at)
